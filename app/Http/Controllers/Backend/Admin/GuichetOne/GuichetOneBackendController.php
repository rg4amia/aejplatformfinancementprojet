...
class GuichetOneBackendController extends Controller
{
    ...
    public function getIndex(){
        ...
        return DataTables::of($projet)
            ...
            ->editColumn('decrireprojet', function ($model){
                return $model->decrireprojet;
            })
            ->editColumn('matriculeprojet', function ($model){
                return $model->matriculeprojet ;
            })
            ->editColumn('montantfinancement', function ($model){
                return $model->montantfinancement ;
            })
