            ...
            <div class="col-md-12 grid-margin">
              <div class="row">
                <div class="col-12 col-xl-8 mb-4 mb-xl-0">
                  ...
                  <h6 class="font-weight-normal mb-0">Tous les systèmes fonctionnent bien ! Vous avez <span class="text-primary">3 alertes non lues!</span></h6>
                </div>
                      ...
                      <div class="carousel-item active">
                        <div class="row">
                          <div class="col-md-12 col-xl-3 d-flex flex-column justify-content-start">
                            ...
                            <p class="card-title text-info">MENTORAT SOLIDAIRE</p>
