              ...
              <div class="card">
                <div class="card-body">
                  ...
                  <div class="table-responsive">
                      <div class="table-responsive">
                          <table id="tableprojetguichettrois" class="display expandable-table" style="width:100%">
                              <thead>
                              <tr>
                                  <th>Date#</th>
                                  <th>Nom</th>
...
@section('js')
    ...
    <script>
        $(function () {
            ...
            var tableprojetguichetun = $('#tableprojetguichettrois').DataTable({
                "language": {
                    "lengthMenu": "_MENU_",
                ...
                serverSide: true,
                ajax: {
                    url: '{{ route('backend.admin.guichet-three.getindex') }}'
                },
