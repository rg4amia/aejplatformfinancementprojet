...
<option selected="" value="">-- Veuillez Sélectionnez --</option>
                 ...
                 <div class="form-group">
                        <div class="col-md-4">
                             <label>Bilan année 1:</label>
                            <input class="form-control" type="file" class="" id="bilanAnnee1"> 
                        </div>
                        <div class="col-md-4">
                             <label>Bilan année 2:</label>
                            <input class="form-control" type="file" class="" id="bilanAnnee2"> 
                        </div>
                        <div class="col-md-4">
                             <label>Bilan année 3:</label>
                            <input class="form-control" type="file" class="" id="bilanAnnee3"> 
                        </div>
                       </div>
