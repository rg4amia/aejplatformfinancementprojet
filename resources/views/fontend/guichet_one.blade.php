					...
					<div class="tour_head1 hotel-book-room">
						...
						<div id="myCarousel1" class="carousel slide" data-ride="carousel">
							...
							<ol class="carousel-indicators carousel-indicators-1">
								<li data-target="#myCarousel1" data-slide-to="0"><img src="{{asset('fontend/images/gallery/t1.jpg')}}" alt="Chania">
								</li>
								<li data-target="#myCarousel1" data-slide-to="1"><img src="{{asset('fontend/images/gallery/t2.jpg')}}" alt="Chania">
								</li>
								<li data-target="#myCarousel1" data-slide-to="2"><img src="{{asset('fontend/images/gallery/t3.jpg')}}" alt="Chania">
								</li>
