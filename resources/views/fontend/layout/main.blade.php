...
<!-- MOBILE MENU -->
@include('fontend.layout.menu_mobile')
<!--HEADER SECTION-->
<section>
    <!-- TOP BAR -->
...
<!--HEADER SECTION-->
@include('fontend.layout.header-sub-menu')
<!--END HEADER SECTION-->
        ...
        <div class="container">
            ...
            <div>
                ...
                <div class="col-md-4 col-sm-6 col-xs-12 b_packages wow slideInUp" data-wow-duration="0.5s">
                    <!-- OFFER BRAND -->
                    <div class="band"> <img src="{{asset('fontend/mages/band.png')}}" alt="" /> </div>
                    <!-- IMAGE -->
                    <div class="v_place_img"> <img src="{{asset('fontend/images/t5.png')}}" alt="Tour Booking" title="Tour Booking" /> </div>
                    <!-- TOUR TITLE & ICONS -->
                    <div class="b_pack rows">
                        ...
                        <div class="col-md-4 col-sm-4 pack_icon">
                            <ul>
                                <li>
                                    <a href="#"><img src="{{asset('fontend/images/clock.png')}}" alt="Date" title="Tour Timing" /> </a>
                                </li>
                                <li>
                                    <a href="#"><img src="{{asset('fontend/images/info.png')}}" alt="Details" title="View more details" /> </a>
                                </li>
                                <li>
                                    <a href="#"><img src="{{asset('fontend/images/price.png')}}" alt="Price" title="Price" /> </a>
                                </li>
                                <li>
                                    <a href="#"><img src="{{asset('fontend/images/map.png')}}" alt="Location" title="Location" /> </a>
                                </li>
                            </ul>
                        </div>
                    </div>
                ...
                <div class="col-md-4 col-sm-6 col-xs-12 b_packages wow fadeInUp" data-wow-duration="0.7s">
                    <!-- OFFER BRAND -->
                    <div class="band"> <img src="{{asset('fontend/images/band1.png')}}" alt="" /> </div>
                    <!-- IMAGE -->
                    <div class="v_place_img"> <img src="{{asset('fontend/images/t1.png')}}" alt="Tour Booking" title="Tour Booking" /> </div>
                    <!-- TOUR TITLE & ICONS -->
                    <div class="b_pack rows">
                        <!-- TOUR TITLE -->
                        <div class="col-md-8 col-sm-8">
                ...
                <div class="col-md-4 col-sm-6 col-xs-12 b_packages wow fadeInUp" data-wow-duration="0.9s">
                    <div class="v_place_img"><img src="{{asset('fontend/images/t2.png')}}" alt="Tour Booking" title="Tour Booking" /> </div>
                    <div class="b_pack rows">
                        <div class="col-md-8 col-sm-8">
                ...
                <div class="col-md-4 col-sm-6 col-xs-12 b_packages wow fadeInUp" data-wow-duration="1.1s">
                    <div class="v_place_img"><img src="{{asset('fontend/images/t3.png')}}" alt="Tour Booking" title="Tour Booking" /> </div>
                    <div class="b_pack rows">
                        <div class="col-md-8 col-sm-8">
                ...
                <div class="col-md-4 col-sm-6 col-xs-12 b_packages wow fadeInUp" data-wow-duration="1.3s">
                    <div class="v_place_img"><img src="{{asset('fontend/images/t4.png')}}" alt="Tour Booking" title="Tour Booking" /> </div>
                    <div class="b_pack rows">
                        <div class="col-md-8 col-sm-8">
                ...
                <div class="col-md-4 col-sm-6 col-xs-12 b_packages wow fadeInUp" data-wow-duration="1.5s">
                    <div class="v_place_img"><img src="{{asset('fontend/images/t6.png')}}" alt="Tour Booking" title="Tour Booking" /> </div>
                    <div class="b_pack rows">
                        <div class="col-md-8 col-sm-8">
...
@include('fontend.layout.scripts')
</body>
